...
# This script uses ANSI escape codes to display a colored Mario graphic in the terminal.
...
# The color variables are used to color the different parts of Mario.
# f0=Black, f1=Red, f3=Yellow, f4=Blue, f7=White
cat << EOF
...
${rst}
     ...
     ${f1}██${f0}█▄█▄█▄█▄█▄█${f1}██
    ${f0}▄███▄${f7}▀▀▀▀▀▀▀▀▀▀▀▀▀▀${f0}▄██▄
    ${f0}█${f7}▀█${f0}▀██▀${f7}█${f0}▀▀▀▀▀${f7}█${f0}▀██▀${f7}█${f0}█
    ${f0}█${f7}███${f0}▄▄▄${f7}█${f0}█▄█${f7}█${f0}█▄█${f7}█${f0}▄▄▄${f7}███${f0}█
    ${f0}█${f7}███${f0}▄▄▄${f7}█${f0}█▄▄${f7}█${f0}█▄█${f7}█${f0}▄▄▄${f7}███${f0}█
    ${f0}█${f7}███${f0}▄▄▄${f7}█${f0}█▄█${f7}█${f0}█▄█${f7}█${f0}▄▄▄${f7}███${f0}█
    ${f0}█${f7}▀█${f0}▀██▀${f7}█${f0}▀▀▀▀▀${f7}█${f0}▀██▀${f7}█${f0}█
    ${f0}▀█▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄${f0}█▀
    ${f0}█${f1}▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀${f0}█
    ${f0}█${f4}█████████████████████████${f0}█
    ${f0}█${f4}█${f7}▀▀▀▀▀${f4}█${f3}o${f4}█${f7}▀▀▀▀▀▀▀▀▀${f4}█${f3}o${f4}█${f7}▀▀▀▀▀${f4}█${f0}█
    ${f0}█${f4}█▄▄▄▄▄${f4}█▄▄▄▄▄▄▄▄▄█▄▄▄▄▄${f4}█${f0}█
    ${f0}█${f4}█████████████████████████${f0}█
    ${f0}█${f4}█████████████████████████${f0}█
    ${f0}█${f1}█████████████████████████${f0}█
